...
def main():
    ...
    menu = ["Home", "Data Processing", "Desreplicator", "Machine Learning / Deep Learning",  "Molecular Docking", "Storytelling with data", "About"]
...
# df = px.data.gapminder()
                ...
                st.write('Comparando seus espectros a', len(base), 'amostras da base')
                ...
                st.write('### Final annotations - LOTUS filter')
                st.dataframe(anotacao_final)

                st.write('### Final annotations - No Filter ')
                st.dataframe(anotacoes)
                ...
                st.write('### Final Annotation')
                st.dataframe(anotacao_final)

                st.markdown("## Results - No Lotus Filter")
                st.write("There are", len(anotacoes), "molecular annotations")

                st.write('### Annotations dataset')
                st.dataframe(anotacoes)
                ...
                # np.save(r"C:\Users\PC\Desktop\testes_amostras\anotacoes", anotacao_final)
                ...
                # np.save(r"C:\Users\PC\Desktop\testes_amostras\anotacoes", anotacoes)

                ## Verificar similaridade de anotacao específica:

               
            else:
                st.write('"Add your data')
        ...
        st.write("##### Insert your annotations")
       ...
       'SMR_VSA4', 'fr_Ar_OH', 'EState_VSA4']
                ...
                st.markdown('Annotations - Machine Learning')
                st.dataframe(df)
                ...
                anotacoes_finais = df.merge(anotacoes_descrip, how='inner', on='index1')
                ...
                os.mkdir(r'C:\Users\Rafa Vieira\Desktop\Projeto_final\pasta_temporaria')
                for i in range(0, len(df)):
                    ...
                    path = r'C:\Users\Rafa Vieira\Desktop\Projeto_final\pasta_temporaria'
                ...
                nomes_amostras_teste = os.listdir(r'C:\Users\Rafa Vieira\Desktop\Projeto_final\pasta_temporaria')
                ...
                model = keras.models.load_model(r'C:\Users\Rafa Vieira\Desktop\Projeto_final\modelo_rede_neural_lumios_final') 
                ...
                import shutil
                shutil.rmtree(r'C:\Users\Rafa Vieira\Desktop\Projeto_final\\pasta_temporaria')
        ...
        st.write("##### Insert your annotations")
        data_file = st.file_uploader("Upload CSV",type=['csv'], accept_multiple_files=False)
        if st.button("Realizar o storytelling"):
            if data_file is not None:
                import pandas as pd
                df = pd.read_csv(data_file)
...
# É um jeito de estimar a função densidade de probabilidade de uma variável aleatória.
                ...
                fig.add_hline(y=-6.1, line_width=3, line_dash = 'dash', line_color = 'black', annotation_text = "-6.1 baseline 7P2G")
        ...
        data_file = st.file_uploader("Upload CSV",type=['csv'], accept_multiple_files=False)
        if st.button("Sim, Realizar o docking!"):
            if data_file is not None:
                import pandas as pd
                df = pd.read_csv(data_file)
                st.dataframe(df)
                ...
                df_docagem = [] 
                for i in  RECEPTOR:
                    WORK_DIR = r'C:\Users\Rafa Vieira\Desktop\Projeto_final'
                    ...
                    for j in prepared_lig_dirs:
                        ...
                        vina = r'C:\Users\Rafa Vieira\Desktop\Projeto_final\Vina\vina.exe'

                        #args = shlex.split(f"{vina} --config_7P2G.txt --ligand {ligand}")
                        # pdbqt = i+'final.pdbqt'
                        # config = i+'config.txt'
                        print(f"{i}final.pdbqt")
                        args = [r'C:\Users\Rafa Vieira\Desktop\Projeto_final\Vina\vina.exe', '--receptor', f"{i}final.pdbqt", '--config', 
                        ...
                        WORK_DIR = r'C:\Users\Rafa Vieira\Desktop\Projeto_final\runs2'
                        ligands = []
                    ...
                    import shutil
                    shutil.rmtree(r'C:\Users\Rafa Vieira\Desktop\Projeto_final\runs2')
                    ...
                    st.write('This is annotations with the best poses - docking')
                ...
                import shutil
                shutil.rmtree(r'C:\Users\Rafa Vieira\Desktop\Projeto_final\teste_teste')
